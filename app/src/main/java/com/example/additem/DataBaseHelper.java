...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public boolean addOne(ItemModel itemMod){
        ...
        Bitmap imageToStoreBitmap=itemMod.getImage();
        objectByteArrayOutputStream=new ByteArrayOutputStream();
        imageToStoreBitmap.compress(Bitmap.CompressFormat.JPEG,100, objectByteArrayOutputStream);
        imageInBytes=objectByteArrayOutputStream.toByteArray();
        ContentValues objectContentValues=new ContentValues();
        objectContentValues.put(COLUMN_STADIUM_IMAGENN,itemMod.getImageName());
        objectContentValues.put(COLUMN_STADIUM_IMAGE,imageInBytes);

        db.insert(STADIUM_TABLE,null,objectContentValues);
        //db.close();
  ...
  /*  public boolean deleteStad(ItemModel itemMod){
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(STADIUM_TABLE,COLUMN_STADIUM_ID,new String[] {String.valueOf(itemMod.getId()) });
        db.close();
...
*/
    ...
    public List<ItemModel> getEveryone(){
        ...
        if(cursor.moveToFirst()){
            ...
            do{
                ...
                ItemModel newStadium = new ItemModel(SName, SID, Stype,Slocation,Sprice,"b",null);
    ...
    /*public void storeImage(ItemModel objItemModel) {

        SQLiteDatabase objSqLiteDatabase =this.getWritableDatabase();
        Bitmap imageToStoreBitmap=objItemModel.getImage();
        objectByteArrayOutputStream=new ByteArrayOutputStream();
        imageToStoreBitmap.compress(Bitmap.CompressFormat.JPEG,100, objectByteArrayOutputStream);
         imageInBytes=objectByteArrayOutputStream.toByteArray();
         ContentValues objectContentValues=new ContentValues();
        objectContentValues.put(COLUMN_STADIUM_IMAGENN,objItemModel.getImageName());
        objectContentValues.put(COLUMN_STADIUM_IMAGE,imageInBytes);

      objSqLiteDatabase.insert(STADIUM_TABLE,null,objectContentValues);
